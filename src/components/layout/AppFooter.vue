<template>
  <footer class="bg-white border-t border-slate-200 dark:border-slate-800 dark:bg-slate-950">
    <div class="grid gap-10 py-12 container-shell md:grid-cols-3">
      ...
      <div>
        <h3 class="text-sm font-semibold uppercase tracking-[0.25em] text-slate-500">Customer Care</h3>
        <ul class="mt-4 space-y-3 text-sm text-slate-600 dark:text-slate-300">
          <li>Shipping & Returns</li>
          <li>Size Guidance</li>
          <li>Care Instructions</li>
          <li>Private Styling</li>
        </ul>
      </div>
      <div>
        <h3 class="text-sm font-semibold uppercase tracking-[0.25em] text-slate-500">Visit</h3>
        <p class="mt-4 text-sm leading-7 text-slate-600 dark:text-slate-300">
          Curated online destination for fashion-led essentials, statement accessories, and premium seasonal edits.
        </p>
      </div>
    </div>
  </footer>
